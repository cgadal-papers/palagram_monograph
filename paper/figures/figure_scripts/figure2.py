...
fig, axarr = plt.subplots(
    5, 1, figsize=figsize, constrained_layout=True, gridspec_kw={"height_ratios": [0.2, 0.2, 1, 1, 1]}
)
...
leg = axarr[0].legend(
    handles=tp.legend_datasets, loc="upper center", ncol=4, borderaxespad=0, title="Datasets", mode="expand"
)
leg = axarr[1].legend(
