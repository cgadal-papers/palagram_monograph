...
Other mechanisms can modify the dynamics of the slumping regime, possibly leading to other possible positions $X_{\text t}$ or times $T_{\text t}$ at which the velocity is no longer time-independent. Depending on the relative intensity of these mechanisms, this can occur prior to the influence of the rarefaction wave or bore. Hence, determining the various regimes related to the prevalence of each mechanism is part of the topic of the present chapter.
